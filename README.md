...
Finally run the server and have all players join, then type in: **/hunt <player name>**
Replace "<player name>" with the name of one of the online players like this: **/hunt wawesome**
